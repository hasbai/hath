<template>
  <div class="relative flex items-center">
    ...
    <div v-show="!isDark" class="absolute right-0 pointer-events-none text-primary">
      <svg height="24" viewBox="-45 -45 90 90" width="24" xmlns="http://www.w3.org/2000/svg">
        <path d="m0 30-15-55.980762L25.980762 15-30 0l55.980762-15L-15 25.980762 0-30l15 55.980762L-25.980762-15 30 0l-55.980762 15L15-25.980762Z"
              fill="currentColor"/>
